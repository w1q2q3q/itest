						...
						<ul class="nav navbar-nav">
							...
							<li class="panel panel-default dropdown"><a
								...
								<div id="dropdown-table" class="panel-collapse collapse">
									<div class="panel-body">
										<ul class="nav navbar-nav">
											<li><a href="table/table.html">定时计划</a></li>
											<li><a href="../cassgroup/findtask">任务内容</a></li>
											<li><a href="table/datatable.html">任务日志</a></li>
										</ul>
									</div>
								</div></li>
							<li class="panel panel-default dropdown"><a
			...
			<div class="container-fluid">
				<div class="side-body">
					<div class="page-title">
						...
						<div class="description">with jquery Datatable for display
							data with most usage functional. such as search, ajax loading,
							pagination, etc.</div>			
					</div>
					<div class="row">
						<div class="col-xs-12">
							<div class="card">
								<div class="card-header">
									<div class="card-title">
										<div class="title">
											<button type="button" class="btn btn-info">添加用例</button>
								...
								<div class="card-body">
									<table class="mytable table table-striped" cellspacing="0"
										width="100%">
										<thead>
											<tr>
												<th>ID</th>
										...
										<% List<addyl> addyl=(List<addyl>)request.getAttribute("cs");
										   List<Object[]>ylzfind=(List<Object[]>)request.getAttribute("ylzfind");
										for(int i=0;i<addyl.size();i++){   
                                           %>			
											<tr>
												<td><%=addyl.get(i).getID() %></td>
												<td><%=addyl.get(i).getName() %></td>
												<td><%=addyl.get(i).getDescribev() %></td>
												<td><%=addyl.get(i).getData() %></td>
												
												<td>
										       	<%
										          String cs="";
										          for(Object[] cc:ylzfind){
										           if(cc[0].toString().equals(String.valueOf(addyl.get(i).getGroupid())))
										           {  cs=cc[1].toString();
										           }
										           }
										           if(cs.equals("")){
										           %>空
										           <%}else{%>
										           <a href="../cassgroup/findcass?id=<%=addyl.get(i).getGroupid()%>"><%=cs%></a>
										          <%}%>
										          </td>
												
												<td>
												<%if(addyl.get(i).getZhuangtai()==1) {%>
												    <button class="btn btn-success btn-xs">
														<i class="glyphicon glyphicon-ok-circle"></i>
													</button>
												<%}else if(addyl.get(i).getZhuangtai()==0){%>
												...
												<td>
													<a href="../addyl/getaddylById?id=<%=addyl.get(i).getID() %>">
													<button class="btn btn-success btn-xs">
													...
													<a href="../jump/deleat?id=<%=addyl.get(i).getID() %>"><button class="btn btn-danger btn-xs">
