                        ...
                        <div class="col-xs-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <div class="title">
                                    <c:if test="${tast[0].method ne 1}">
                                    <button type="button" onclick="location.href='../cassgroup/taskrun?id=${id}'" class="btn btn-primary btn-info" data-toggle="modal" data-target="#modalInfo">执行</button>
                                    </c:if>
                                </div>
                               </div>
                                </div>
                               <form action="../cassgroup/zhurun" id="formid" method="post">
                                ...
                                <div class="card-body">
                                    <table class="mytable table table-striped" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                        <c:forEach var="tast" items="${tast}">
                                            <tr>  
                                                <td>${tast.id}</td>
                                                <td>${tast.number}</td>
                                                <td>${tast.date}</td>
                                                <td><button type="button" onclick="location.href='../cassgroup/report?cassid=${tast.cassid}&id=${tast.id}&number=${tast.number}&method=${tast.method}'" class="btn btn-success btn-xs"><i class="glyphicon glyphicon-eye-open"></i></button>
                                                    <button class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></button>
                                                    <button type="button" onclick="location.href='../jump/zdeleat?id='" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i></button>
                                                </td>
                                            </tr>
                                         </c:forEach>  
