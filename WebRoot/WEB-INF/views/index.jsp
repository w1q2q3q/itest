...
<body>
	<div class="headerBar">
		<div class="logoBar login_logo">
			<div class="comWidth">
				<div class="logo fl">
					<a href="#"><img
						src="${pageContext.request.contextPath}/image/logo.jpg" alt="慕课网"></a>
				</div>
	...
	<form action="itest/login" method="post">
		<div class="loginBox">
			<div class="login_cont">
				<ul class="login">
				    ...
				    <li><input type="button" value="注销" class="login_btn"onclick="javascrtpt:window.location.href='logout'"></li>
				</ul>
	...
	<div class="footer">
		...
		<p class="web">
			<a href="#"><img
				src="${pageContext.request.contextPath}/image/webLogo.jpg"
